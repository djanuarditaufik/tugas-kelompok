...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/bsi.jpg" type="image/ico" />
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/ganteng.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Djanuardi Taufik</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/ganteng.jpg" alt="">Djanuardi Taufik
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2022 Web Programing : Djanuardi Taufik
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
